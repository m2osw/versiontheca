...
/** \file
 * \brief The version of the versiontheca library at compile time.
 *
 * This file records the versiontheca library library version at compile time.
 *
...
{
    return VERSIONTHECA_VERSION_MAJOR;
}
...
{
    return VERSIONTHECA_VERSION_MINOR;
}
...
{
    return VERSIONTHECA_VERSION_PATCH;
}
...
{
    return VERSIONTHECA_VERSION_STRING;
}
