...
CATCH_TEST_CASE("invalid_debian_versions", "[invalid]")
{
    ...
    CATCH_START_SECTION("invalid_debian_versions: randomized invalid character")
    {
...
CATCH_TEST_CASE("bad_debian_calls", "[invalid]")
{
    CATCH_START_SECTION("bad_debian_calls: next without a version")
    {
        versiontheca::debian::pointer_t t(std::make_shared<versiontheca::debian>());
        versiontheca::versiontheca v(t);
    ...
    CATCH_START_SECTION("bad_debian_calls: previous without a version")
    {
        versiontheca::debian::pointer_t t(std::make_shared<versiontheca::debian>());
        versiontheca::versiontheca v(t);
    ...
    CATCH_START_SECTION("bad_debian_calls: next out of bounds")
    {
        versiontheca::versiontheca::pointer_t a(create("1.5.3-r5"));
        for(int p(-100); p < 0; ++p)
        {
    ...
    CATCH_START_SECTION("bad_debian_calls: previous out of bounds")
    {
        versiontheca::versiontheca::pointer_t a(create("1.5.3-r5"));
        for(int p(-100); p < 0; ++p)
        {
    ...
    CATCH_START_SECTION("bad_debian_calls: resize out of bounds")
    {
        versiontheca::versiontheca::pointer_t a(create("1.5.3-r5"));
    ...
    CATCH_START_SECTION("bad_debian_calls: next/erase out of bounds")
    {
    ...
    CATCH_START_SECTION("bad_debian_calls: compare against an empty (invalid) version")
    {
        versiontheca::versiontheca::pointer_t a(create("1.2"));
        versiontheca::debian::pointer_t t(std::make_shared<versiontheca::debian>());
    ...
    CATCH_START_SECTION("bad_debian_calls: compare using an empty (invalid) version")
    {
        versiontheca::debian::pointer_t t(std::make_shared<versiontheca::debian>());
        versiontheca::versiontheca empty(t, "");
